...
build: ## Build all images
	$(DC) $(DEVFLAGS) $(PRODFLAGS) build $(HARDBUILDFLAGS) 
...
build_sso: ## Build SSO minimal
	$(DC) $(DEVFLAGS) $(PRODFLAGS) build $(HARDBUILDFLAGS) $(SSOSERVICES)
...
build_sso_test: ## Build SSO_test minimal
	$(DC) $(DEVFLAGS) $(PRODFLAGS) build $(HARDBUILDFLAGS) $(SSOTESTSERVICES)
